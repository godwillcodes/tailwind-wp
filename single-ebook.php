...
">
    ...
    <div class="w-full px-6 lg:px-0 relative z-20 py-16 lg:py-40">
        <div class="text-start gap-y-4 max-w-7xl mx-auto">
            ...
            <div class="text-[#F9F8F6] text-base font-light max-w-2xl mb-8">
                <?php the_content(); ?>
            </div>
        ...
        <div class="max-w-7xl shadow-sm mx-auto px-6 lg:px-0 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 items-stretch">
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Download the Ebook</h3>
                    <p class="text-white mb-2 text-lg">Fill out the form to instantly get your free copy and access
