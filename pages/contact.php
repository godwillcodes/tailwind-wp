...
<section class="relative w-full bg-white py-24 px-6 md:px-12">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <!-- Left Column -->
        <div class=" text-black p-10 flex flex-col justify-center rounded-md" data-aos="fade-up"
            ...
            <dl class="mt-8 text-lg text-gray-800">
                ...
                <div class="mt-3">
                    ...
                    <dd class="flex">
                        ...
                        <span class="ml-3"><a href="mailto:info@pgls.com"
                                class="hover:text-secondary">info@pgls.com</a></span>
                    </dd>
                </div>
            </dl>
        ...
        <!-- Right Column -->
        <div class="border border-gray-300 rounded-md p-8 bg-white shadow-sm" data-aos="fade-down">
...
<section class="w-full max-w-7xl mx-auto px-6 md:px-0 pb-20">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div
            ...
            <p class="text-base leading-relaxed">The Address, Muthangari Drive</p>
        </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="relative group overflow-hidden rounded shadow-md h-full bg-[#F9F8F6] text-black p-10">
                ...
                <div
                    class="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6 opacity-0 group-hover:opacity-100 transition-all duration-100 ease-out bg-gradient-to-b from-transparent via-[#98C44180] to-[#00615580] scale-95 group-hover:scale-100">
                    <a href="/about"
                    ...
                    <img src="http://pg.local/wp-content/themes/tailwind-wp/assets/icons/arrow-side.svg"
                        alt="Arrow Icon"
