<div class="max-w-7xl mx-auto px-6 py-6 flex md:hidden justify-between items-center">
  ...
  <div x-data="{ open: false, submenu: null }" @keydown.escape.window="open = false; submenu = null" x-cloak>
    ...
    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
      ...
      class="fixed inset-0 z-40 bg-black/50 backdrop-blur-sm" @click="open = false; submenu = null" aria-hidden="true">
    </div>
    ...
    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-300"
      ...
      <div x-show="submenu === null" x-transition>
        ...
        <nav class="space-y-4">
          ...
          <a href="#"
            class="block text-base font-semibold text-white hover:text-[#98C441] transition">Home</a>
          <a href="#"
            class="block text-base font-semibold text-white hover:text-[#98C441] transition">About</a>
          <a href="#"
            class="block text-base font-semibold text-white hover:text-[#98C441] transition">Services</a>
          <a href="#"
            class="block text-base font-semibold text-white hover:text-[#98C441] transition">Contact</a>
        </nav>
      ...
      <div x-show="submenu !== null" x-transition>
        <div class="flex justify-between items-center mb-6">
          ...
          <span class="text-base font-semibold" x-text="submenu.charAt(0).toUpperCase() + submenu.slice(1)"></span>
          <button @click="open = false" class="text-white hover:text-gray-300 focus:outline-none">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
