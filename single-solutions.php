...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-0">
        ...
        <div class="grid gap-6 grid-cols-1 lg:grid-cols-2">
           ...
           <div class="block md:flex flex-col md:flex-row items-center md:justify-between p-6 sm:p-8 md:p-12 border border-[#DFDAD4] rounded-lg lg:col-span-2">
    ...
    <div class="flex flex-wrap justify-center md:justify-end gap-4 md:gap-4">
        ...
        <a href="" target="_blank" rel="noopener">
            <span class="flex items-center justify-center h-24 w-24 sm:h-28 sm:w-28 md:h-32 md:w-32 rounded-full bg-gradient-to-b from-gray-100 to-green-100 shadow-sm" aria-label="Piedmont Global Recognition">
                <img src="http://pg.local/wp-content/uploads/fc6c468ca3bf0a126824235c072b86a661d06935.png" alt="Piedmont Global Recognition" class="max-h-20 max-w-20 sm:max-h-24 sm:max-w-24 md:max-h-20 md:max-w-20 object-contain">
            </span>
        </a>
        <?php } ?>
    </div>
...
<?php for ($i = 0; $i < 2; $i++) { ?>
            ...
            <div class="items-justify gap-4 border border-[#DFDAD4] rounded-lg p-12 shadow-md">
                <div class="flex-shrink-0">
                    <span class="flex items-center justify-center h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-gradient-to-b from-gray-100 to-green-100 shadow-sm" aria-label="Piedmont Global Recognition">
                    <img src="http://pg.local/wp-content/uploads/fc6c468ca3bf0a126824235c072b86a661d06935.png" alt="Piedmont Global Recognition" class="max-h-10 lg:max-h-16 max-w-10 lg:max-w-16 object-contain">
                </span>
                </div>
                <div class="pt-4">
...
<section class="bg-[#1F3131] py-28 text-center">
  <div class="max-w-3xl mx-auto px-4">
    ...
    <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
      ...
      <a href="#"
        class="flex items-center text-[#F9F8F6] font-medium text-base lg:text-lg hover:underline">
